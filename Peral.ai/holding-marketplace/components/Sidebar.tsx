...
import { LayoutDashboard, TreeDeciduous, Brain, FileText, Search, LogOut, CreditCard, Coins } from "lucide-react";
...
const NAV = [
  ...
  { href: "/dashboard/tokens",    icon: Coins,           label: "Tokens & Créditos"     },
